...
if (!isset($_SESSION["s-admin-login"]))
{
  header("Location: s-admin-login.php");
}
...
if(isset($_SESSION['FirstVisit']) == true && isset($_POST["allresults"])){
...
else if(isset($_SESSION['FirstVisit']) == true && isset($_POST["approved"])){
	header("Location: s-admin.php");
	$select="SELECT * FROM signup WHERE 1=1  ";	
	$select .="AND approve='approved' ";
	$_SESSION["countRows"]=mysqli_num_rows( mysqli_query($con, $select) );
	$_SESSION["select"]=$select;
}
else if(isset($_SESSION['FirstVisit']) == true && isset($_POST["declined"])){
	header("Location: s-admin.php");
	$select="SELECT * FROM signup WHERE 1=1  ";	
	$select .="AND approve='declined' ";
	$_SESSION["countRows"]=mysqli_num_rows( mysqli_query($con, $select) );
	$_SESSION["select"]=$select;
}
else if(isset($_SESSION['FirstVisit']) == true && isset($_POST["pending"])){
	header("Location: s-admin.php");
	$select="SELECT * FROM signup WHERE 1=1  ";	
	$select .="AND approve='pending' ";
	$_SESSION["countRows"]=mysqli_num_rows( mysqli_query($con, $select) );
	$_SESSION["select"]=$select;
}
...
if(isset($_SESSION['FirstVisit']) == true && !isset($_POST["submitForm"]) && !isset($_POST["submitSearchById"]) && !isset($_GET["page"]) 
	&& isset($_POST["pending"]) && isset($_POST["declined"]) && isset($_POST["approved"]) && isset($_POST["allresults"]) ){
	$_SESSION["FirstVisit"]=true;	
	$select="SELECT * FROM signup WHERE 1=1  ";	
	$_SESSION["countRows"]=mysqli_num_rows( mysqli_query($con, $select) );
	$_SESSION["select"]=$select;
				...
				<div class="col-lg-3 col-md-3 col-sm-4" id="leftSideBar">
					...
					<div class="col-lg-12" style="padding:0px; margin-bottom:100px" >
						...
						<div class="col-lg-12 " id="searchByIdBox">
							<form name="searchById" method="post" action="s-admin.php">
						...
						<div class="col-lg-12 " style="padding-top:0px; margin-top:15px; padding:0px; ">
							<div class="col-lg-12 " id="advancedSearchBox">
								<div class="col-lg-12 " style="margin-bottom:20px; padding:0px; margin-top:0px; ">
									...
									<div class="col-lg-12 " style="padding:0px;">
									<form method="post" action="s-admin.php" name="searchForm"   >
										...
										<div class="col-lg-12 col-xs-12"  id="sticky"  >
											<div class="col-lg-12 col-xs-12" style="padding:0px; background-color:#FFFFFF;">
												<button type="submit" class="btn btn-success btn-block" name="submitForm" id="searchButtonHeight">
...
function District()
{
	...
	{ 
		document.getElementById("showCity").style.display="block";
				...
				<div class="col-lg-9 col-md-9 col-sm-8 " style=" padding:5px;" id="centerBar">
				<div class="col-lg-12" style="padding:10px; background-color:#FFFFFF; box-shadow:0px 0px 5px silver; margin-bottom:40px; border-radius:3px;">
					<span style="color:#999999; font-weight:600">FILTER RESULTS</span><br />
						
						<div class="col-lg-3" style="padding:0px">
							<form action="" method="post">
								<button name="allresults" type="submit" class="btn btn-default btn-block" style="border-radius:0px" n>
									<i class="fas fa-home" style="margin-right:10px"></i>SHOW ALL RESULTS
								</button>
							</form>
						</div>
						<div class="col-lg-3" style="padding:0px">
							<form action="" method="post">
								<button name="pending" type="submit" class="btn btn-primary btn-block" style="border-radius:0px" n>
									<i class="fas fa-user-plus" style="margin-right:10px"></i>NEW (PENDING)
								</button>
							</form>
						</div>
						<div class="col-lg-3" style="padding:0px">
							<form action="" method="post">
								<button type="submit" name="approved" class="btn btn-success btn-block" style="border-radius:0px">
									<i class="fas fa-check-circle" style="margin-right:10px"></i> APPROVED
								</button>
							</form>
						</div>
						<div class="col-lg-3" style="padding:0px">
							<form action="" method="post">
								<button name="declined" type="submit" class="btn btn-info btn-block" style="border-radius:0px">
									<i class="fas fa-times-circle" style="margin-right:10px"></i>DECLINED
								</button>
							</form>
						</div>
				...
				<div style="text-decoration:none" id="hidePrefrencesParent" >
					<div class="col-lg-12 col-md-12 col-xs-12" id="changeCenter" style="padding:10px; background-color:#FFFFFF; box-shadow:0px 0px 5px lightgray">
						<div class="col-lg-3 col-md-3 col-xs-12">
							<span style="text-align:left; font-size:14px; margin-left:10px; color:#008040; font-weight:700; font-family:'Calibri Light';" 
								data-toggle="tooltip" data-placement="right" title="GENDER">
								<?php echo strtoupper($array2['gender'])?>
							</span>
							<span style="text-align:left; font-size:10px; margin-left:35px; color:#999999" data-toggle="tooltip" data-placement="right" 
								title="ACCOUTN CREATED DATE">
								<?php echo $array2['date']." | ".$array2['time']?>
							</span>
							
							<div style="height:160px; width:200px; margin-left:auto; margin-right:auto; border-radius:5px; border:2px solid #E1E1E1; cursor:pointer" 
							data-toggle="modal" data-target="#<?php echo $array2['id']?>">
								<img src="<?php echo $array2['uploadProfilePicture']; ?>" height="100%" width="100%" style="border-radius:2px;" alt="User Image">
							</div>
							<div class="modal fade" id="<?php echo $array2['id']?>" role="dialog">
								<div class="modal-dialog">
									<div class="modal-content">
										<div class="modal-header">
											<button type="button" class="close" data-dismiss="modal">&times;</button>
											<h4><?php echo $array2['firstName']." ".$array2['lastName']?></h4>
										</div>
							...
							<div id="namePadding"><span style='font-weight:500; text-decoration:underline; font-size:18px'></span>
								
								<span style="font-family:'Segoe UI'; color:#000080; font-weight:600">
									<?php echo "<span style='font-weight:700; font-size:18px; text-decoration:underline;' 
												data-toggle='tooltip' data-placement='right' title='FIRST NAME | LAST NAME'>"
											.$array2['firstName']." ".$lastName=$array2['lastName']."</span>";
									?>
									<span data-toggle="tooltip" data-placement="right" title="PROFILE ID" style="font-size:12px; font-weight:500; color:#CCCCCC; ">
										<?php echo "<span style='font-weight:600'>(id: ".$array2['id'].")</span>"; ?>
									</span><br />
								
									
									
									<div data-toggle="tooltip" data-placement="right" title="DATE OF BIRTH" style="font-size:12px; font-weight:500; color:#008080; margin-top:9px">
										<i class="fas fa-user-clock" style="margin-right:6px"></i>
										<span style='font-weight:600'>
											<?php $row11 = array('dob'=>$array2['dob']);	echo ageCalculator($row11['dob'])." old";?>
										</span>
									</div>
									<div data-toggle="tooltip" data-placement="right" title="HEIGHT" style="font-size:12px; font-weight:500; color:#008080; margin-top:5px">
										<i class="fas fa-male" style="margin-right:17px"></i>
										<?php echo "<span style='font-weight:600'>".$array2['height']." ft</span>"; ?>
									</div>
									<div data-toggle="tooltip" data-placement="right" title="MARITAL STATUS" 
										style="font-size:12px; font-weight:500; color:#008080; margin-top:5px">
										<i class="far fa-user-circle" style="margin-right:10px"></i>
										<?php echo "<span style='font-weight:600'>".$array2['maritalStatus']."</span>"; ?>
									</div>
									<div data-toggle="tooltip" data-placement="right" title="EDUCATION" style="font-size:12px; font-weight:500; color:#008080; margin-top:5px">
										<i class="fas fa-user-graduate" style="margin-right:12px;"></i>
										<?php echo "<span style='font-weight:600'>".$array2['education']."</span>"; ?>
									</div>
									<div data-toggle="tooltip" data-placement="right" title="RELIGION" style="font-size:12px; font-weight:500; color:#008080; margin-top:5px">
										<i class="fas fa-mosque" style="margin-right:7px"></i>
										<?php echo "<span style='font-weight:600'>".$array2['religion']."</span>"; ?>
									</div>
									<div data-toggle="tooltip" data-placement="right" title="PROFESSION" style="font-size:12px; font-weight:500; color:#008080; margin-top:5px">
										<i class="fas fa-user-shield" style="margin-right:8px"></i>
										<?php echo "<span style='font-weight:600'>".$array2['profession']."</span>"; ?>
									</div>
									<div data-toggle="tooltip" data-placement="right" title="EMAIL ADDRESS" style="font-size:12px; font-weight:500; color:#008080; margin-top:5px">
										<i class="fas fa-envelope" style="margin-right:11px"></i>
										<?php echo "<span style='font-weight:600'>".$array2['email']."</span>"; ?>
									</div>
									<div data-toggle="tooltip" data-placement="right" title="PASSWORD" style="font-size:12px; font-weight:500; color:#008080; margin-top:5px">
										<i class="fas fa-eye-slash" style="margin-right:10px"></i>
										<?php echo "<span style='font-weight:600'>".$array2['password']."</span>"; ?>
									</div>
									<div data-toggle="tooltip" data-placement="right" title="MOBILE NO" style="font-size:12px; font-weight:600; color:#008080; margin-top:5px">
										<i class="fas fa-phone" style="margin-right:11px"></i>
										<?php echo "<span style='font-weight:600'>".$array2['mobile']."</span>"; ?>
									</div>
									<div data-toggle="tooltip" data-placement="right" title="ADDRESS" style="font-size:12px; font-weight:600; color:#008080; margin-top:5px">
										<i class="fas fa-map-marker-alt" style="margin-right:13px"></i>
										<?php 
											if($array2['city'] != "" ) {
												if($array2['city'] != $array2['district']){
													echo "Location: <span style='font-weight:600'>".
													$array2['city'].", ".$array2['district'].", ".$array2['province'].",".$array2['country']."</span>";
												}
												else{
													echo "<span style='font-weight:600'>".
													  $array2['district'].", ".$array2['province'].",".$array2['country']."</span>";
												}
												   
											} 
											else{
												echo "<span style='font-weight:600'>".$array2['country']."</span>"; 
											}
										?>
									</div>
								</span>
							...
							<div id="visitProfile">
								<?php
									if($array2['approve']=="approved"){?>
									<div style="background-color:#92B558; padding:0px; padding-top:28px; padding-bottom:28px; text-align:center; border-radius:3px">
										<i class="fas fa-check-circle" style="margin-right:10px"></i>ACCOUNT APPROVED
									</div>
										
									<?php }
									else if($array2['approve']=="declined"){?>
										<div style="background-color:#9F9C99; padding:0px; padding-top:28px; padding-bottom:28px; text-align:center; border-radius:3px">
											<i class="fas fa-times-circle" style="margin-right:10px"></i>DECLINED
										</div>
									
									<?php }
									else{?>
									<form action="approve-decline.php" method="post">
										<input type="hidden" name="id" value="<?php echo $array2['id'];?>" />
										<button type="submit" name="approve_button" class="btn btn-success btn-block">
											<i class="fas fa-check-circle" style="margin-right:10px"></i>Approve
										</button>
										<button type="submit" name="decline_button" class="btn btn-info btn-block">
											<i class="fas fa-times-circle" style="margin-right:10px"></i>Decline
										</button>
									</form> 
									<?php }?>
						...
						<div class="col-lg-9 col-md-9 col-xs-12" id="about" >
							<div class="col-lg-12 col-sm-12 col-xs-12" style=" padding:0px; color:#333333; font-family:'Segoe UI'; padding-right:0px; 
								...
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding:0px; margin-top:5px" >
									<p id="aboutText" style="margin-bottom:8px;">Primary Detail</p>
									
									<p data-toggle="tooltip" data-placement="right" title="PROFILE CREATED BY">
										<span id="name-tags">Profile Created By: </span><?php echo $array2['profileCreatedBy']; ?>
									</p>
									<p data-toggle="tooltip" data-placement="right" title="LANGUAGE">
										<span id="name-tags">Language: </span><?php echo $array2['language']; ?>
									</p>
									<p data-toggle="tooltip" data-placement="right" title="SALARY">
										<span id="name-tags">Salary: </span><?php echo $array2['salary']?>
									</p>
									<p data-toggle="tooltip" data-placement="right" title="CLAN">
										<span id="name-tags">Clan: </span><?php echo $array2['clan']?>
									</p>
									<p data-toggle="tooltip" data-placement="right" title="CASTE">
										<span id="name-tags">Caste: </span><?php echo $array2['caste']?>
									</p>
									<p data-toggle="tooltip" data-placement="right" title="COMPLEXION">
										<span id="name-tags">Complexion: </span><?php echo $array2['complexion']; ?>
									</p>
									<p data-toggle="tooltip" data-placement="right" title="BODY TYPE">
										<span id="name-tags">Body Type: </span><?php echo $array2['bodyType']?>
									</p>
									<p data-toggle="tooltip" data-placement="right" title="HOBBY">
										<span id="name-tags">Hobby: </span><?php echo $array2['hobby']?>
									</p>
									<p data-toggle="tooltip" data-placement="right" title="DISABLITY">
										<span id="name-tags">Any Disability: </span><?php echo $array2['disability']?>
									</p>
								</div>
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding:0px; margin-top:5px" >
									<p id="aboutText" style="margin-bottom:8px; ">Secondary Detail</p>
									
									<p data-toggle="tooltip" data-placement="right" title="FATHER STATUS">
										<span id="name-tags">Father Status: </span><?php echo $array2['fatherStatus']?>
									</p>
									<p data-toggle="tooltip" data-placement="right" title="MOTHER STATUS">
										<span id="name-tags">Mother Status: </span><?php echo $array2['motherStatus']?>
									</p>
									<p data-toggle="tooltip" data-placement="right" title="Height">
										<span id="name-tags">Brothers: </span><?php echo $array2['noOfBrothers']?>
									</p>
									<p data-toggle="tooltip" data-placement="right" title="NO OF BROTHERS">
										<span id="name-tags">Sisters: </span><?php echo $array2['noOfSisters']?>
									</p>
									<p data-toggle="tooltip" data-placement="right" title="FAMILY TYPE">
										<span id="name-tags">Family Type: </span><?php echo $array2['familyType']?>
									</p>
									<p data-toggle="tooltip" data-placement="right" title="FAMILY VALUES">
										<span id="name-tags">Family Values: </span><?php echo $array2['familyValues']?>
									</p>
									<p data-toggle="tooltip" data-placement="right" title="FAMILY AFFLUENCE">
										<span id="name-tags">Family Affluence: </span><?php echo $array2['familyAffluence']?>
									</p>
									<p data-toggle="tooltip" data-placement="right" title="PUBLIC PROFILE">
										<span id="name-tags">Public Profile: </span><?php echo $array2['publicProfile']?>
									</p>
									<p data-toggle="tooltip" data-placement="right" title="MAKE ME HIDE">
										<span id="name-tags">Hide My Profile: </span><?php echo $array2['makeMeHide']?>
									</p>
								</div>
								<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4" style="padding:0px; padding-left:5px; margin-top:5px">
									<p style="font-family:'Segoe UI'; margin-bottom:-2px; font-weight:700; color:#00539c">
										Partner Preferences
									</p>
									<p data-toggle="tooltip" data-placement="left" title="PARTNER AGE" style="margin-top:12px">
										<span id="name-tags">Partner Marital Status: </span><?php echo $array2['pMaritalStatus']; ?>
									</p>
									<p data-toggle="tooltip" data-placement="left" title="PARTNER AGE" style="margin-top:8px">
										<span id="name-tags">Partner Age: </span><?php echo $array2['pAge']; ?>
									</p>
									<p data-toggle="tooltip" data-placement="left" title="PARTNER HEIGHT">
										<span id="name-tags">Partner Height: </span><?php echo $array2['pHeight']; ?>
									</p>
									<p data-toggle="tooltip" data-placement="left" title="PARTNER RELIGION">
										<span id="name-tags">Partner Religion: </span><?php echo $array2['pReligion']; ?>
									</p>
									<p data-toggle="tooltip" data-placement="left" title="PARTNER LANGUAGE">
										<span id="name-tags">Partner Language: </span><?php echo $array2['pLanguage']; ?>
									</p>
									<p data-toggle="tooltip" data-placement="left" title="PARTNER EDUCATION">
										<span id="name-tags">Partner Education: </span><?php echo $array2['pEducation']; ?>
									</p>
									<p data-toggle="tooltip" data-placement="left" title="PARTNER COMPLEXION">
										<span id="name-tags">Partner Complexion: </span><?php echo $array2['pComplexion']; ?>
									</p>
									<p data-toggle="tooltip" data-placement="left" title="PARTNER CLAN">
										<span id="name-tags">Partner Clan: </span><?php echo $array2['pClan']; ?>
									</p>
									<p data-toggle="tooltip" data-placement="left" title="PARTNER MARITAL STATUS">
										<span id="name-tags">Partner Family Affluence: </span><?php echo $array2['pFamilyAffluence']; ?>
									</p>
									<p data-toggle="tooltip" data-placement="left" title="PARTNER LOCATION">
										<span id="name-tags">Partner Location: </span><?php echo $array2['pLocation']; ?>
									</p>
									
									
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" 
									style="padding:5px; padding-left:5px; margin-top:5px; color:#666666; border:1px solid #CCCCCC; border-radius:5px; ">
									<p style="font-family:'Segoe UI'; margin-bottom:-2px; font-weight:600; color:#333333">
										<span style="color:#bc70a4">
										<i class="fas fa-user-friends" style="margin-right:10px"></i> About Partner</span>
									</p>
									<div style="margin-top:8px; margin-left:34px; text-overflow:ellipsis ;  white-space: normal"><?php echo $array2['pAbout']; ?></div>
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" 
									style="padding:5px; padding-left:5px; margin-top:5px; color:#666666; border:1px solid #CCCCCC; border-radius:5px; ">
									<p style="font-family:'Segoe UI'; margin-bottom:-2px; font-weight:600; color:#333333">
										<span style="color:#bc70a4">
											<i class="fas fa-user-edit" style="margin-right:10px"></i> About Myself
										</span>
									</p>
									<div style="margin-top:8px; margin-left:34px; text-overflow:ellipsis ;  white-space: normal">
										<?php echo $array2['aboutYourself']; ?>
									</div>
								</div>
								<script>
										...
										<div class="col-lg-12 col-xs-12" style="border:0px solid #CCCCCC; padding:0px; border-radius:5px;">
											<div class="col-lg-12 col-xs-12" style=" height:auto; padding:0px">
												...
												<?php	if( $page>1 ){	$previous=$page-1; ?>
														...
														<a rel="canonical"  href="s-admin.php?page=<?php echo $previous; ?> ">
															...
															<a rel="canonical" href="s-admin.php?page=<?php echo $firstOne-1;?>">
														...
														for($row=1; $row<=$pages; $row++)
														{
															...
															for($col=1; $col<=$lengthOfRow; $col++)
															{
																if($arrayOfIndexes[$row][$col] == $page)
																{
																	...
																	?>
																	<a rel="canonical" href="s-admin.php?page=<?php echo $arrayOfIndexes[$row][$thisRow];?>">
																			<div class="col-lg-1 col-xs-1" style="padding:0px; margin-left:1px">
												...
												<?php }	else if($page==1){	
														...
														<a rel="canonical" href="s-admin.php?page=<?php echo $lastOne;?>">
															<div class="col-lg-1 col-xs-1" style="padding:0px; margin-left:1px">
																<button type="button" class="btn btn-default btn-block" style="border-radius:0px;">
														...
														<a rel="canonical" href="s-admin.php?page=<?php echo $page+1; ?>  ">
															<div class="col-lg-3 col-xs-3" style="padding:0px; margin-left:1px">
																<button type="button" class="btn btn-default btn-block" style="border-radius:0px; 
																							border-top-right-radius:3px;border-bottom-right-radius:3px">
																	Next<span style="margin-left:12px; font-size:16px" class="glyphicon glyphicon-chevron-right"></span>
