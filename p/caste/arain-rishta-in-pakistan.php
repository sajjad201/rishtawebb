...
<head>
    <?php include('../links-two.php');?>



<!---Pagination--->
<?php					
$sql="SELECT * FROM signup where caste='arain' ";	//Change your table name and colunm
                                ...
                                <div class="col-lg-12 col-xs-12">
                                    <div class="col-lg-12 col-xs-12" style=" height:auto; padding:0px">
                                        <?php	if( $page>1 ){	$previous=$page-1; ?>
                                                <a href="arain-rishta-in-pakistan.php?page=<?php echo $previous; ?> ">
                                                ...
                                                <?php if($firstOne != 1){?>
                                                <a href="arain-rishta-in-pakistan.php?page=<?php echo $firstOne-1;?>">
                                        ...
                                        <?php }	if($page >= $pages){
                                                for($row=1; $row<=$pages; $row++){
                                                    ...
                                                    for($col=1; $col<=$lengthOfRow; $col++){
                                                        if($arrayOfIndexes[$row][$col] == $page){
                                                            for($thisRow=1; $thisRow<=$lengthOfRow; $thisRow++){?>
                                                                <a href="arain-rishta-in-pakistan.php?page=<?php echo $arrayOfIndexes[$row][$thisRow];?>">
                                                                    <div class="col-lg-1 col-xs-2" style="padding:0px">
                                            ...
                                            <?php }	else if($page==1){	
                                                ...
                                                $lastOne=$lastOne+1;
                                                if($pages >= $lastOne){?>
                                                <a href="arain-rishta-in-pakistan.php?page=<?php echo $lastOne;?>">
                                                    <div class="col-lg-1 col-xs-2" style="padding:0px">
                                                        <button type="button" class="btn btn-default btn-block pagination-btn">
                                                ...
                                                <?php }?>
                                                <a href="arain-rishta-in-pakistan.php?page=<?php echo $page+1; ?>  ">
                                                    <div class="col-lg-3 col-xs-12" style="padding:0px">
                                                        <button type="button" class="btn btn-default btn-block pagination-btn">
                                                            Next<span style="margin-left:15px; font-size:16px" class="glyphicon glyphicon-chevron-right"></span>
                                                        </button>
